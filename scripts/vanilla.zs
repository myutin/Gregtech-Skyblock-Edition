...
// move rock breaker recipes earlier
rock_breaker.findRecipe(60, [<minecraft:stone:1>], null).remove();
rock_breaker.findRecipe(60, [<minecraft:stone:3>], null).remove();
rock_breaker.findRecipe(60, [<minecraft:stone:5>], null).remove();
rock_breaker.findRecipe(240, [<chisel:marble:0>], null).remove();
rock_breaker.findRecipe(960, [<gregtech:stone_smooth:0>], null).remove();
rock_breaker.findRecipe(960, [<gregtech:stone_smooth:1>], null).remove();
rock_breaker.findRecipe(240, [<chisel:basalt:0>], null).remove();
